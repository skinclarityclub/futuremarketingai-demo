...
export const Tooltip: React.FC<TooltipProps> = ({
  ...
  const arrowClasses = {
    ...
    bottom: 'bottom-full left-1/2 -translate-x-1/2 border-b-bg-card border-l-transparent border-r-transparent border-t-transparent',
    left: 'left-full top-1/2 -translate-y-1/2 border-l-bg-card border-t-transparent border-b-transparent border-r-transparent',
    right: 'right-full top-1/2 -translate-y-1/2 border-r-bg-card border-t-transparent border-b-transparent border-l-transparent',
  };
